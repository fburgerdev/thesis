...
\NewDocumentEnvironment{mystatement}{momo}{%
  ...
  \vspace{2.5pt}
  % end
  \ifthenelse{\equal{#1}{definition}}{\end{definition}\end{leftbar}}{}%
  \ifthenelse{\equal{#1}{theorem}}{\end{theorem}\end{leftbar}}{}%
  \ifthenelse{\equal{#1}{proposition}}{\end{proposition}\end{leftbar}}{}%
  \ifthenelse{\equal{#1}{corollary}}{\end{corollary}\end{leftbar}}{}%
  \ifthenelse{\equal{#1}{lemma}}{\end{lemma}\end{leftbar}}{}%
  \ifthenelse{\equal{#1}{remark}}{\end{remark}}{}%
  \ifthenelse{\equal{#1}{example}}{\end{example}\end{leftbar}}{}%
}
