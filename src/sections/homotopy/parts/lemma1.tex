\begin{scope}
    ...
    \begin{myproof}
        ...
        Here we identified an open subset of $E(\bb[B \cross [\half, 1]])$ with $B \cross [\half, 1] \cross \R^n$ using \myintref{microbundle::paracompact}.
        ...
        But $\bbleft$ is trivial, hence $\ind{r}\bbleft$ is trivial as well (\myintref{induced::trivial}) which concludes the proof.
    \end{myproof}
\end{scope}