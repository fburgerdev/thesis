\begin{scope}
    ...
    \begin{myproof}
        ...
        covering $r_\alpha$ in order to `compose' them to our required bundle-germ.
        \begin{sectionize}
            % local bundle-germ
            \item Constructing bundle-germs $R_\alpha$ covering $r_\alpha$
            ...
            using the bundle-germ $\germ{\be{\A}}{\be{\A \cap \A'}}$ represented by
            \[ (a, x) \mapsto (r_\alpha(a), x). \]
            Pieced together with the identity bundle-germ $\bb[\A']$
            ($\A$ and $\A'$ are both closed),
            ...
            we may assume an ordering for $\coll{V_\alpha}$.
