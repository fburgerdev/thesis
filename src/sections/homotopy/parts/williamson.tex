...
% foreword lemma
\begin{myparagraph}
    Firstly, we show a lemma that is necessary for the proof of the proposition.
\end{myparagraph}
...
\begin{myproof}[of the proposition]
    ...
    \begin{enumerate}
        ...
        it follows from the \extref{domain invariance theorem} that the $g_b$ are open maps.
        ...
        that is injective and fiber-preserving and therefore an open map (apply 1.).
