\begin{mystatement}{lemma}{normal::total} Let $N \sub M$ be a submanifold and let $r: V \sub M \to N$ be a retraction. Then there exists a normal microbundle $\bn$ of $N$ in $E(\ind{r}\bt_N)$.  \end{mystatement}
