...
\begin{myproof}
    ...
    assuming only a homeomorphism $\phi: V \isomto \phi(V)$ with the properties required above.
    ...
    for example given by $\mu_\eps(x) = \tan(\frac{\abs{x}\cdot\pi}{2\eps}) x$.
    ...
    % commutativity
    Commutativity with $i$ and $id \cross 0$ is given by
