% definition
\begin{mystatement}{definition}{whitney::definition}[59]
...
\begin{myproof}[that $\whitney{\bb_1}{\bb_2}$ is a microbundle]
    ...
    \begin{itemize}
        ...
        which is a homeomorphism with the inverse
