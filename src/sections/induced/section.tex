...
\end{myparagraph}
\input{src/sections/induced/parts/definition}
\input{src/sections/induced/parts/restriction}
\begin{myparagraph}
    Next, we provide two criteria
    to show that an induced microbundle is trivial.
\end{myparagraph}
\input{src/sections/induced/parts/trivial}
\input{src/sections/induced/parts/const}
\input{src/sections/induced/parts/composition}
\input{src/sections/induced/parts/cone}
\input{src/sections/induced/parts/simplex}