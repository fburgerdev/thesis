...
\begin{myproof}[of the proposition]
    ...
    \begin{steps}
        ...
        We define a map $\tilde{U} \cross \R^n \to \tilde{U} \cross \R^n$ given by
        \[ \tilde{U} \cross \R^n \cong  \tilde{U} \cross \ball[\eps] \xto{\phi \circ f \circ \inv{\phi}} \tilde{U} \cross \R^n \]
        that is injective and fiber-preserving and hence an open map (Step 1).
        It follows that $f: \inv{\phi}(\tilde{U} \cross \ball[\eps]) \to V'$
