...
\begin{myproof}[that $\ba \vee \bb$ is a rooted microbundle]
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            The fact that $\ba$ is still a microbundle is justified by \myintref{microbundle::total}.
            It follows that
            ...
            By definining 
            \[ V_a' = \inv{\phi_a}(U_a \cross X) \]
            together with
            \[ \phi_a': V_a' \isomto U_a \cross \R^n \]
        ...
        the microbundles remain unchanged using \myintref{microbundle::total}.
