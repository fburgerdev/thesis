...
\begin{myparagraph}
    ...
    that will be deferred until \myintref{chapter::suspension}.
\end{myparagraph}
...
\begin{myproof}
    ...
    Hence, the start of induction follows directly from \myintref{whitney::bouqet}.   
    ...
    \begin{enumerate}
        ...
        \[
            ...
            = \whitney{\be{B'}}{\be{B'}}
        \]
        is trivial, it follows from \myintref{induced::cone} that we can extend $\whitney{\bb}{\eta}$ over $B \sqcup CB'$
        ...
        With \myintref{homotopy::theorem} and \myintref{whitney::bouqet},
