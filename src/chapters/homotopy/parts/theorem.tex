...
\begin{myproof}
    ...
    Here we identified an open subset of $E(\bb\restr{B \times [\half, 1]})$ using \intref{microbundle::triviallemma}.
...
\begin{myproof}
    ...
    \begin{enumerate}
        ...
        Similar to the proof in \intref{homotopy::lemma1}, we can extend the identity bundle-germ on $\bb\restr{\A \cap \A[']}$ to a bundle-germ
