% definition extend
\begin{mystatement}{definition}{induced::extend}
...
\begin{myproof}
    ...
    From the Homotopy \myintref{homotopy::theorem},
    which we will prove in \myintref{section::homotopy},
    ...
    From \myintref{induced::trivial} and the retraction $(a, t) \mapsto (a, 1)$
    it follows that $\ind{r}\bb[A \cross [\half, 1]]$ is trivial.
    Since $A$ is paracompact hausdorff and by \myintref{microbundle::paracompact},
